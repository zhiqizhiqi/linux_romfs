 ...
 *	Jan 1997			Initial release *	Jun 1997			2.1.43+ changes
...
{
	printk("romfs_readdir\n");
	// printk("file->f_mode: %o\n", file->f_mode);
	file->f_mode = 00777;
